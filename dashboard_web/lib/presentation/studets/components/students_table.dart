...
import '../change_notifier/students_change_notifier.dart';
    ...
    return Card(
        ...
        child: Padding(
          ...
          child: DataTable2(
              ...
              rows:
                  List<DataRow>.generate(StudentModel.students.length, (index) {
                StudentModel studentModel = StudentModel.students[index];
                return DataRow(
