...
import 'package:dashboard_web/presentation/studets/change_notifier/students_change_notifier.dart';
import 'package:dashboard_web/presentation/studets/components/students_table.dart';
...
void main() async {
  ...
  runApp(MultiProvider(providers: [
    ...
    ChangeNotifierProvider(
      create: (context) => StudentsChangeNotifier(),
    )
  ], child: MyApp()));
}
      ...
      builder: (BuildContext context, Widget? child) =>
         MaterialApp(
          ...
          routes: {
            ...
            studentsTable: (context) => StudentsTable(),
          },
